# app_simple.py - Streamlit app for image upload only (works on cloud)
...
def main():
    ...
    if st.session_state.detector is None:
        ...
        st.markdown("""
        ### How to use:
        1. Wait for the model to load (first time takes ~30 seconds)
        2. Click **Initialize Detector** in the sidebar
        3. Upload an image below
        4. Click **Detect** to see the result
        
        ### Features:
        - ✅ REAL face detection
        - ⚠️ SPOOF attack detection
        - 🎯 Confidence scoring
        - 📊 Real-time statistics
        """)
        
        # Show example
        st.info("💡 **Tip:** Upload a clear face image for best results!")
        return
                ...
                with col2:
                    ...
                    if class_name == "REAL":
                        ...
                        **Decision:** This is a GENUINE face
                        ...
                        The face appears to be authentic with high confidence.
                        """)
                        st.balloons()
    ...
    <div style="text-align: center; color: gray; padding: 1rem;">
        <p>🔒 Privacy: Images are processed locally and not stored</p>
        <p>🎯 Made with ❤️ for Face Spoof Detection</p>
    </div>
    """, unsafe_allow_html=True)
